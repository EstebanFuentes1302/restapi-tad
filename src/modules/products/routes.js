...
async function insert(req, res){
    try{
        ...
        response.success(req, res, 'Producto Agregado Exitosamente', 200)
    }catch(err){
        console.log(err);
...
async function update(req, res){
    try{
        ...
        response.success(req, res, 'Producto Actualizado Correctamente', 200)
    }catch(err){
        console.log(err);
        response.error(req, res, items, 500)
    }
...
async function erase(req, res){
    ...
    try{
        ...
        response.success(req, res, 'Producto eliminado correctamente', 200)
    }catch(err){
        console.log(err);
        response.error(req, res, items, 500)
    }
